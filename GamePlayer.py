...
def main():
    ...
    first_guesses = \
        ['TARSE', 'TORSE', 'THUMP', 'CARSE', 'CLAMP', 'CLASP', 'RAINE', 'ROAST', 'CARTE', 'RAISE', 'RECAP', 'SCALP',
         'VIDEO', 'PATIO', 'EASEL', 'LAKES', 'KALES']
...
# older list of possible words -  trimmed if they didn't solve it
# 'ABUSE',
# 'ADEPT',
# 'ADIEU',
# 'ALONE',
